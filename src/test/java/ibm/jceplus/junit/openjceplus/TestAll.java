...
@Suite.SuiteClasses({TestAES.class, TestAES_128.class, TestAES256Interop.class, TestAESCCM.class,
        ...
        TestImplementationClassesFinal.class, TestMD5.class, TestInvalidArrayIndex.class,
        TestPublicMethodsToMakeNonPublic.class, TestRSA.class, TestRSA_512.class,
        TestRSA_1024.class, TestRSA_2048.class, TestRSAKey.class, TestRSAPSS.class,
