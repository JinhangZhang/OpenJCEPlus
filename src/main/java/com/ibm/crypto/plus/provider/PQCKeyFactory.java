...
class PQCKeyFactory extends KeyFactorySpi {
    ...
    @Override
    protected <T extends KeySpec> T engineGetKeySpec(
            Key key, Class<T> keySpec) throws InvalidKeySpecException {
        ...
        try {
            ...
            throw new InvalidKeySpecException(
                    "Unsupported key specification: ", e);
        }
    }
    ...
    private void checkKeyAlgo(Key key) throws InvalidKeyException {
        // this key may have a generic name such as ML-KEM or ML-DSA or a specific name such as ML-KEM-768
