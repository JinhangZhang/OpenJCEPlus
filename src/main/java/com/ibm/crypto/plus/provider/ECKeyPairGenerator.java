...
public final class ECKeyPairGenerator extends KeyPairGeneratorSpi {
    ...
    public ECKeyPairGenerator(OpenJCEPlusProvider provider) {
        ...
        System.err.println("=== OJCP ECKeyPairGenerator CREATED in ECKeyPairGenerator(OpenJCEPlusProvider provider) ===");
    ...
    public KeyPair generateKeyPair() {
        ...
        try {
            ...
            if (this.oid != null) {
                ...
                ecKey = ECKey.generateKeyPair(
                        encodedCustomCurveParameters, cryptoRandom, provider);
            } else if (this.keysize > 0 && (ecSpec == null)) {

                ecKey = ECKey.generateKeyPair(this.keysize, cryptoRandom, provider);
            }
