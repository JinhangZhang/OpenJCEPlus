...
class RSAKeyFactory extends KeyFactorySpi {
    ...
    public final static int[] ALLOWABLE_MODLEN_FIPS_SIGN = {2048, 3072, 4096};
    public final static int[] ALLOWABLE_MODLEN_FIPS_VERIFY = {1024, 2048, 3072, 4096};
     ...
     */
    static void checkKeyLengths(int modulusLen, BigInteger exponent, int minModulusLen,
            int maxModulusLen, int[] specificModulesLen) throws InvalidKeyException {
        ...
        if (!Arrays.asList(specificModulesLen).contains(modulusLen)) {
